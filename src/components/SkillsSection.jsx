        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {categories.map((category, key) => (
            <button
              ...
              className={cn("px-5 py-2 rounded-full transition-colors duration-300 capitalize", activeCategory == category ? "bg-primary text-blue-900" : "bg-secondary/70 text-foreground hover:bg-secondary")}
            >
              {category}
            </button>
          ))}
